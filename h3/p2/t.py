...
def knapsack_recurs(maxW,items,dictA):
    i = len(items)
    ...
    #case1
    v1,w1 = knapsack_recurs(maxW,items[0:-1],dictA)
#    print "case1: i,v1,w1,maxW =",i,v1,w1,maxW
    ...
    v = lastitem[0]
    w = lastitem[1]
    v2,w2 = knapsack_recurs(maxW-w,items[0:-1],dictA)
    v2 += v 
    w2 += w
...
dictA = {}
print knapsack_recurs(Wb,items,dictA)
